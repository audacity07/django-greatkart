# greatkart (outer project folder)/ orders folder/ views.py
...
def place_order(request, total=0, quantity=0):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            data.save()  # --> When this data is saved the it created a
            # order id in the DB because we added new data
            # and we will use this to create unique
